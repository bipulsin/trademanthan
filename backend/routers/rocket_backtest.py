"""Read-only Layer 10f backtest summary. Does not touch live Rocket/Crash."""
...
from backend.services.rocket_layer10f_backtest import fetch_summary

router = APIRouter(tags=["rocket-backtest"])


@router.get("/rocket_backtest_summary")
def rocket_backtest_summary(
