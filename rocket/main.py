...
def backtest(
    ...
    meta_filter: bool = typer.Option(
        ...
        help="Run ML meta-filter (breadth+CLV+HTF+RVOL, 0–3/day, P≥0.12)",
    ),
    min_prob: float = typer.Option(0.12, "--min-prob", help="Expansion-only bulk floor (spikes >0.85 discarded)"),
    ...
    clv_threshold: float = typer.Option(0.15, "--clv-threshold", help="|CLV| minimum for directional close"),
    ...
    rvol_min: float = typer.Option(1.25, "--rvol-min", help="Minimum relative volume"),
...
def compare_timeframes(
    ...
    limit: int = typer.Option(200, "--limit"),
    output: Optional[Path] = typer.Option(None, "--output", help="HTML tear sheet path"),
    min_prob: float = typer.Option(0.12, "--min-prob"),
