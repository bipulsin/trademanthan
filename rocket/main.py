...
def backtest(
    ...
    meta_filter: bool = typer.Option(
        ...
        help="Run ML meta-filter (breadth+CLV+HTF+RVOL, 0–3/day, P≥0.36)",
    ),
    min_prob: float = typer.Option(0.36, "--min-prob", help="Continuous-bulk floor (spikes >0.85 discarded)"),
...
def compare_timeframes(
    ...
    limit: int = typer.Option(200, "--limit"),
    output: Optional[Path] = typer.Option(None, "--output", help="HTML tear sheet path"),
    min_prob: float = typer.Option(0.36, "--min-prob"),
