...
def backtest(
    ...
    meta_filter: bool = typer.Option(
        ...
        help="Run ML meta-filter (absolute floor P≥0.50, max 3/day) and comparative report",
    ),
    min_prob: float = typer.Option(0.50, "--min-prob", help="Absolute P(win) floor (never below 0.50)"),
...
def compare_timeframes(
    ...
    limit: int = typer.Option(200, "--limit"),
    output: Optional[Path] = typer.Option(None, "--output", help="HTML tear sheet path"),
    min_prob: float = typer.Option(0.50, "--min-prob"),
