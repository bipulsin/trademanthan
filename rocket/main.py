...
def backtest(
    ...
    meta_filter: bool = typer.Option(
        ...
        help="Run ML meta-filter (relative daily top-K (anomaly floor 0.30), max 3/day) and comparative report",
    ),
    min_prob: float = typer.Option(0.30, "--min-prob", help="Day anomaly floor (skip day if best score < this)"),
...
def compare_timeframes(
    ...
    limit: int = typer.Option(200, "--limit"),
    output: Optional[Path] = typer.Option(None, "--output", help="HTML tear sheet path"),
    min_prob: float = typer.Option(0.30, "--min-prob"),
